...
public class CustomServerModServer implements DedicatedServerModInitializer {
	...
	public void onInitializeServer() {
		...
		LOGGER.info("[Custom Server Mod] Server initialized: Teufel's Essentials - Lumberjack + Telekinesis + Excavation + Auto Smelting + Infinite Totem (vanilla NBT) + MsgSpy");
	}
}