...
public class CustomServerModServer implements DedicatedServerModInitializer {
	...
	public void onInitializeServer() {
		...
		AutoUpdater.checkOnStartup(net.minecraft.server.MinecraftServer.getServer() != null ? net.minecraft.server.MinecraftServer.getServer() : null);
		// Fallback: also check when server fully started via ServerLifecycleEvents
